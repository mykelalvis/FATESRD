...
**Advancement:** The smaller the number of skills in your list vs. the default, the less frequent you'll want skill point awards from advancement. Perhaps allow them only during [[Advancement#Breakthroughs|"power ups"]], or restrict them another way.

**Alternatives to the pyramid:**

- **Diamond:** A broad middle (about a third of them) that tapers towards the top and bottom of the range, _e.g.,_ 1 at +0, 2 at +1, 3
  at +2, 2 at +3, 1 at +4.
...
- **Free + Cap:** Give players enough skill points to make a pyramid (or other shape), but don't mandate it. They can buy whatever,
...
A countdown can have more than one trigger if you want; perhaps the countdown proceeds at a predictable pace until something happens that accelerates it. You could also give a different trigger to each box on the countdown track, if you want a specific series of events to set off
the outcome.
...
If nothing comes of it and you haven't rolled to defend at all by the time your next turn comes around, you gain a [[Aspects and Fate Points (FCon)#Boosts|boost]] as you've gotten the opportunity to prepare for your next action. This offsets "losing a turn" because you focused your efforts on defending against something that didn't happen at all.
...
If an obstacle can attack the PCs, it's a **hazard**. Fire jets, rolling boulders, or a sniper too far away to be dealt with directly---they're all hazards. Every hazard has a name, a skill rating, and a [Weapon rating](index.html#weapon-and-armor-ratings) of 1 to 4.
...
Between combining skills and creating advantages for [teamwork](../challenges-conflicts-and-contests/index.html#teamwork), a group of PCs can really overwhelm a single opponent. This is fine if you want to respect the advantage of numbers, but not great if you want to present a "big bad" that's the equal of the whole group. 

But remember, for monsters and other big threats it's acceptable to [break the rules](../being-game-master/index.html#monsters-big-bads-and-other-threats)---so do so by looking at ways to counteract the group's usual advantage of numbers, while still giving them a chance. Here are a few suggestions for ways you might do that. You can use one or more of these in combination for especially difficult or terrifying final bosses.
...
You could **scale things up** to let your big bad operate at a higher scale than the PCs, using the [scale option](index.html#scale). You could do this even if scale isn't normally in play in your campaign---these rules need only apply when a big bad takes the field!
...
- The big bad gets a **bonus to skill rolls** that's equal to the group's maximum potential [teamwork bonus](../challenges-conflicts-and-contests/index.html#teamwork) --- the number of PCs acting against the big bad minus one (so a +2 vs a group of 3, etc). This bonus can't do better than double the big bad's affected skill, though, just as with PCs (or maybe you'll break _that_ rule too).
...
In Fate, anything can be a character, so why not a map? When **the threat is a map**, your big bad has [zones](../challenges-conflicts-and-contests/index.html#zones) which must be navigated to achieve victory.
