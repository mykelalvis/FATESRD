...
>
> Cynere is [Tempted by Shiny Things], and Zird has [Rivals in the Collegia ][Arcan]a, which implies that the Collegia's wealth might end up on Cynere's radar at an inconvenient time for Zird. Therefore, Cynere getting a lucrative contract to steal one of the Collegia's sacred treasures at the same time that Zird's rivals try to put him on trial for crimes against creation would probably be a big problem for both of them.
>
...
There's also some room to extend material from this scenario into the future. Maybe the identity of Cynere's opponent doesn't get answered this session at all---that's okay, because it's a detail Amanda can always bring back in a later session.If you end up with a really large number of story questions (like eight or more), keep in mind that you don't necessarily have to answer them all in one scenario---you can bring up the questions you don't answer, either as foreshadowing or to set up stuff you're going to do in the following scenario. In fact, that's exactly how you make [strong arcs](../building-arc/index.html "Building An Arc")---you have a pile of related story questions, and you take two or three scenarios to answer them all.