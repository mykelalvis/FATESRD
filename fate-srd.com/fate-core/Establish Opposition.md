...
For each NPC that you have, decide whether you need to make them a supporting or main. Stat them up according to the guidelines given in [Running the Game](../running-game/index.html).
