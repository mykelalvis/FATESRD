...
You can look at an aspect-related problem as a very large-scale kind of [event compel](../invoking-compelling-aspects/index.html "Invoking & Compelling Aspects"). The setup is a little more work, but the structure is similar---having an aspect suggests or implies something problematic for the PC or multiple PCs, but unlike a compel, it's something they can't easily resolve or deal with in the moment.
...
- Does someone connected to the issue have a particular reason to target the PC because of an aspect?### How Many Problems Do I Need
